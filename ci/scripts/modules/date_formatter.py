...
def fix_js_date_formats(report_dir: str) -> None:
    ...
    if DRY_RUN:
        logger.info(f"DRY-RUN: Would fix date formats in JavaScript files with date {today}")
        return
        ...
        try:
            ...
            if os.path.basename(js_file) == 'app.js':
                ...
                if os.path.exists(inline_date_js_path):
                    ...
                    logger.warning(f"Inline date formatter JavaScript not found: {inline_date_js_path}")
